...
function TerminalProjects () {
    return (
        <section className="t-projects" id="projects">
                ...
                {projects.map(project => (
                    <div key={project.id} className="t-projects__card">
                        ...
                        <div className="t-projects__links">
                            {project.githubUrl && (
                                <a href={project.githubUrl} target="_blank" className="t-projects__link">
                                    Github
                                </a>
                            )}
                            {project.githubBackendUrl && (
                                <a href={project.githubBackendUrl} target="_blank" className="t-projects__link">
                                    Backend
                                </a>
                            )}
                            {project.liveUrl && (
                                <a href={project.liveUrl} target="_blank" className="t-projects__link">
                                    Live Demo 
                                </a>
                            )}
                        </div>
